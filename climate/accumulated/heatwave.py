...
from base.datasets.gee_heatwave import GEEHeatwaveData
...
class CliAccumulatedHeatwave(Indicator, NormalizationMixin):
    def __init__(
        self,
        config: ConfigParser,
        grid: GlobalBaseGrid,
        ...
        self.event_data = GEEHeatwaveData(local=False, config=config)
...
if __name__ == "__main__":
    ...
    indicator = CliAccumulatedHeatwave(config=config, grid=grid)
    indicator.run()
